<template>
  <section>
    <div style="width: 800px;">
      <Button @click="changeGeometry('BoxGeometry')">BoxGeometry</Button>
      <Button @click="changeGeometry('CapsuleGeometry')">CapsuleGeometry</Button>
      <Button @click="changeGeometry('CylinderGeometry')">CylinderGeometry</Button>
      <Button @click="changeGeometry('ConeGeometry')">ConeGeometry</Button>
      <Button @click="changeGeometry('CircleGeometry')">CircleGeometry</Button>
      <Button @click="changeGeometry('DodecahedronGeometry')">DodecahedronGeometry</Button>
      <Button @click="changeGeometry('IcosahedronGeometry')">IcosahedronGeometry</Button>
      <Button @click="changeGeometry('LatheGeometry')">LatheGeometry</Button>
      <Button @click="changeGeometry('OctahedronGeometry')">OctahedronGeometry</Button>
      <Button @click="changeGeometry('PlaneGeometry')">PlaneGeometry</Button>
      <Button @click="changeGeometry('RingGeometry')">RingGeometry</Button>
      <Button @click="changeGeometry('SphereGeometry')">SphereGeometry</Button>
      <Button @click="changeGeometry('TetrahedronGeometry')">TetrahedronGeometry</Button>
      <Button @click="changeGeometry('TorusGeometry')">TorusGeometry</Button>
      <Button @click="changeGeometry('TorusKnotGeometry')">TorusKnotGeometry</Button>
      <Button @click="changeGeometry('TubeGeometry')">TubeGeometry</Button>
      <Button @click="changeGeometry('ShapeGeometry')">ShapeGeometry</Button>
      <Button @click="changeGeometry('ExtrudeGeometry')">ExtrudeGeometry</Button>
    </div>
    <div ref="geometry" id="geometry"></div>
  </section>
</template>
...
let camera, splineCamera, cameraHelper, cameraEye
...
export default {
  ...
  data() {
    return {
      selectedGeometry: 'PlaneGeometry',
    }
  },
  methods: {
    initThree() {
      ...
      function chooseFromHash(mesh) {
        const selectedGeometry = that.selectedGeometry || 'PlaneGeometry'
      ...
      that.$refs.geometry.appendChild(renderer.domElement)
    ...
    changeGeometry(geometryType) {
      document.querySelector("#geometry > canvas").remove("*")
      document.querySelector(".lil-gui").remove("*")
      this.selectedGeometry = geometryType
      this.initThree()
    }
  },
}
